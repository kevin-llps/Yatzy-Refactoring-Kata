...
class YatzyOnePlusTest {
    ...
    private static final DefaultLosingScoreCalculator DEFAULT_LOSING_SCORE_CALCULATOR = new DefaultLosingScoreCalculator();
    Yatzy2 yatzy2 = new Yatzy2(DEFAULT_LOSING_SCORE_CALCULATOR);

    static Stream<YatzyCalculator> yatzyProvider() {
        return Stream.of(new Yatzy2(DEFAULT_LOSING_SCORE_CALCULATOR), new Yatzy3());
    }
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void yatzy_scores_50(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void test_1s(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void twos(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void threes(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void fours(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void fives(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void sixes(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void pair(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void two_pair(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void three_of_a_kind(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void four_of_a_knd(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void smallStraight(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void largeStraight(YatzyCalculator yatzy2) {
    ...
    @ParameterizedTest
    @MethodSource("yatzyProvider")
    void fullHouse(YatzyCalculator yatzy2) {
